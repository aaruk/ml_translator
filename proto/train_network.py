...
def train_test_mozhi_net(tr_fpath=None, tst_fpath=None, retrain=True, 
  ...
  mozhi_net = nn.NeuralNet(4, activation="tanh", max_epochs=500, eta=0.1, phr_wrd_cnt=phr_wrd_cnt)
  mozhi_net.init_layer(0, node_count=wvecs_len, seq_node_cnt=0)#wts_fname="models/pretrained/layer_wts_0_e217.txt")
  mozhi_net.init_layer(1, node_count=wvecs_len, seq_node_cnt=wvecs_len)#wts_fname="models/pretrained/layer_wts_1_e217.txt")
  mozhi_net.init_layer(2, node_count=wvecs_len, seq_node_cnt=wvecs_len)#wts_fname="models/pretrained/layer_wts_2_e217.txt")
  mozhi_net.init_layer(3, node_count=wvecs_len, seq_node_cnt=0)#wts_fname="models/pretrained/layer_wts_3_e217.txt")
  #mozhi_net.init_layer(4, node_count=wvecs_len, seq_node_cnt=0)#wts_fname="models/pretrained/layer_wts_4_e217.txt")
  #mozhi_net.init_layer(5, node_count=wvecs_len, seq_node_cnt=0)#wts_fname="models/pretrained/layer_wts_5_e217.txt")
  #mozhi_net.init_layer(6, node_count=wvecs_len, seq_node_cnt=0)#wts_fname="models/pretrained/layer_wts_6_e217.txt")
  # mozhi_net.init_layer(7, node_count=wvecs_len, seq_node_cnt=0)
  
  
  if retrain:
    # Retrain the neural network with the training data received.
    if reenc:
      # Reencode the words into their feature vector representation using SVD.
      # This was the method we had used first.
      ...
      # load feature vectors from encoding done previously from CBOW embedding
...
if __name__ == "__main__":
  train_test_mozhi_net(tr_fpath="datasets\\europarl\\", 
